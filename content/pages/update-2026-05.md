...
Seven conversations in motion this month worth naming.
...
Companyon Ventures, with a second partner added to the list this month, same May 7 call as Maine Venture Fund. Sent the v4 overview deck. The partner framed the bootstrap path as "legacy vs retirement" optionality, which is a useful internal framing. Companyon is now two partners on this update list (the first was added in April).
