...
Here's what Geneva's check registers map to when you run entity resolution at scale:

| Entity | Ticker | Sightings | What They're Paying For |
|---|---|---|---|
| AT&T | T | 202 | Monthly phone service, pedestal installations |
| W.W. Grainger | GWW | 152 | Industrial supplies, maintenance equipment |
| Comcast | CMCSA | 139 | Cable service, internet |
| Home Depot | HD | 138 | Hardware, maintenance supplies |
| Amazon | AMZN | 124 | Office supplies, electronics, cleaning supplies, server equipment |
| UPS | UPS | 122 | Shipping |
| Verizon | VZ | 120 | Communications |
| Core & Main | CNM | 112 | Water meters, gaskets, pipes |
| Airgas | AIQUY | 100 | Cylinder rentals, welding supplies |
| NextEra Energy | NEE | 90 | Electric utility |

That's ten companies, all publicly traded, all receiving regular payments from a single municipality. AT&T shows up 202 times. Grainger shows up 152 times. This is recurring revenue from government operations, visible in public documents that nobody in the market is reading.

Now multiply by 1,800 municipalities.
...
Week of Mar 3 was the initial backfill -- Geneva has deep archives. The Accounts Payable Invoice Reports alone account for 220 check registers going back years. This historical depth is the point: it's not just what a city is spending today, it's the longitudinal pattern of who they pay, how much, and whether it's changing.
...
Geneva has 12 registered tower structures, more than you'd expect for a city this size. The same FOAA-based assessor data acquisition that works in Maine works in Illinois -- different statute (Illinois FOIA), different contact roles, different response patterns. The system adapts.
...
Nobody at Grainger's investor relations desk knows that Geneva, Illinois pays them 152 times a year. We do. And we know the same thing for every municipality in the pipeline.
