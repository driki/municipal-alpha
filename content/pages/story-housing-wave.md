...
1. **State legislation passes** (LD 2003 in Maine, MBTA Communities Act in Massachusetts, Act 47 in Vermont). This creates a compliance deadline.
2. **Early adopters move fast.** Towns with planning staff and political will pass new ordinances within months. These show up as "ordinance" events in our pipeline.
3. **Middle towns debate.** Planning boards hold hearings, residents push back, revisions circulate. This produces agendas, minutes, reports -- all captured.
4. **Late adopters rush.** As deadlines approach, holdout towns scramble. The document volume spikes.
5. **Construction follows.** Zoning changes don't build houses, but they enable permits. Permit activity lags zoning changes by 6-18 months.
